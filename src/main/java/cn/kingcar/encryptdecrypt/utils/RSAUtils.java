...
//        Map testJson  = new HashMap(); testJson.put("ssss","dfsdfad");testJson.put("age",45);
//
//        String  test = JSON.toJSONString(testJson);
//        String data = encryptedDataOnJava(test, publickey);
